...
import utils.*;
import players.group_AA.Params;
import players.group_AA.newPlayer;
import java.io.*;
...
public class Run {
    ...
    private static void printHelp()
    {
        ...
        System.out.println("\t\t 6 group_AA 200 iterations, length: 12");
    }
    ...
    public static void main(String[] args) throws FileNotFoundException  {
        ...
        //default
        if(args.length == 0)
            args = new String[]{"0", "5", "10", "-1", "2", "3", "4", "5"};
        ...
        try {
            String policies[] = new String[]{"uct"};//,"uct2Tuned","uctBayesian","epsilonGreedy","epsilonGreedyDecay","AMAF","alphaAMAF","cutOFFAMAF","grave"};
            Boolean AMAFPolicyEnable;


            for (String policy: policies) {
                if (policy == "uct" || policy == "uct2Tuned"|| policy == "uctBayesian"|| policy == "epsilonGreedy"|| policy == "epsilonGreedyDecay")
                    AMAFPolicyEnable = false;
                else
                    AMAFPolicyEnable = true;
...
//                        params.heuristic_method = params.CUSTOM_HEURISTIC;
                            params.heuristic_method = params.HEURISTICSAA;

                            params.policyType = policy;
                            params.AMAFPolicyEnable = AMAFPolicyEnable;
                            p = new newPlayer(seed, playerID++, params);
                            playerStr[i - 4] = "Player_AA"+"_"+policy;
                            break;
                        default:
