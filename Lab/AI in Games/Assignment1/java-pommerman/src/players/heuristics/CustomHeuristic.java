...
//            System.out.println("diffTeammates"+diffTeammates+" weight "+diffTeammates * FACTOR_TEAM);
//            System.out.println("diffEnemies"+diffEnemies+" weight "+(diffEnemies / 3.0) * FACTOR_ENEMY);
//            System.out.println("diffWoods"+diffWoods+" weight "+(diffWoods / maxWoods) * FACTOR_WOODS);
//            System.out.println("diffCanKick"+diffCanKick+" weight "+diffCanKick * FACTOR_CANKCIK);
//            System.out.println("diffBlastStrength"+diffBlastStrength+" weight "+(diffBlastStrength / maxBlastStrength) * FACTOR_BLAST);


//            System.out.println(((diffEnemies / 3.0) * FACTOR_ENEMY + diffTeammates * FACTOR_TEAM + (diffWoods / maxWoods) * FACTOR_WOODS
//                    + diffCanKick * FACTOR_CANKCIK + (diffBlastStrength / maxBlastStrength) * FACTOR_BLAST));
            return ((diffEnemies / 3.0) * FACTOR_ENEMY + diffTeammates * FACTOR_TEAM + (diffWoods / maxWoods) * FACTOR_WOODS
                    + diffCanKick * FACTOR_CANKCIK + (diffBlastStrength / maxBlastStrength) * FACTOR_BLAST);
//            return Math.random();
//            return Math.round(Math.log((diffEnemies / 3.0) * FACTOR_ENEMY) + Math.log(diffTeammates * FACTOR_TEAM) + Math.log((diffWoods / maxWoods) * FACTOR_WOODS)
//                    + Math.log(diffCanKick * FACTOR_CANKCIK) + Math.log((diffBlastStrength / maxBlastStrength) * FACTOR_BLAST));
        }
    }
}
