...
public class newPlayer  extends ParameterizedPlayer {
    ...
    public newPlayer (long seed, int id) {
        this(seed, id, new Params());
    }

    public newPlayer (long seed, int id, Params params) {
    ...
    @Override
    public newPlayer  copy() {
        return new newPlayer (seed, playerID, params);
    }
}