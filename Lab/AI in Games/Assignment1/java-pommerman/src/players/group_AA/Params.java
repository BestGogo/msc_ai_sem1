...
public class Params implements ParameterSet {
    ...
    public final int HEURISTICSAA = 2;
...
//    public int heuristic_method = CUSTOM_HEURISTIC;
    public int heuristic_method = HEURISTICSAA;
    ...
    public Map<String, Object[]> getParameterValues() {
        ...
        parameterValues.put("heuristic_method", new Integer[]{CUSTOM_HEURISTIC, ADVANCED_HEURISTIC,HEURISTICSAA});
        parameterValues.put("policyType",new String[]{"uct","uct2Tuned","uctBayesian","epsilonGreedy","epsilonGreedyDecay","AMAF","alphaAMAF","cutOFFAMAF","grave"});
    ...
    public Map<String, String[]> constantNames() {
        ...
        names.put("heuristic_method", new String[]{"CUSTOM_HEURISTIC", "ADVANCED_HEURISTIC","HEURISTICSAA"});
        return names;
    }
}
